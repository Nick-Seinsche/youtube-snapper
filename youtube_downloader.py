doc = """
    ...
    >>> ytdownload.py -v "VidLink1" "VidLink2" "VidLink3" --hq --mkv
    >>> ytdownload.py -p "Playlistlink" --mp3
    >>> ytdownload.py -f "Filelink"
...
def download_video(video_url):
    ...
    if video.includes_video_track:
        ...
        if args.mkv:
            os.system("ffmpeg -hide_banner -loglevel warning -stats"
                      " -i tempvid.{} -i tempaud.{} -c "
                      "copy \"{}\".mkv".format(video_filetype,
                                               audio_filetype, vid_title))
        else:  # args.mp4
            os.system("ffmpeg -hide_banner -loglevel warning "
...
def download_sound(video_url):
    ...
    os.system(f"ffmpeg -hide_banner -loglevel warning -stats "
...
if __name__ == "__main__":
    ...
    g.add_argument("-file", "-f", type=str, metavar="FILEPATH",
                   help="Downloads all urls specified in file"
